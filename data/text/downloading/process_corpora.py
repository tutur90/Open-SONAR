...
def setup_environment(args: argparse.Namespace, logger: logging.Logger) -> str:
    """Set up directories and download required models."""
...
def main() -> None:
    ...
    model_path = setup_environment(args, logger)
